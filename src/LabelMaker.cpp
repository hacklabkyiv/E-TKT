...
AccelStepper stepperFeed(MICROSTEP_Feed, 17, 18, 5, 19);
...
void lightChar(float state) { analogWrite(ledChar, int(state * 128)); }
...
void feedLabel() {
  ...
  delay(10);
  stepperFeed.runToNewPosition(stepperFeed.currentPosition() -
                               stepsPerRevolutionFeed / 8);
  delay(10);
